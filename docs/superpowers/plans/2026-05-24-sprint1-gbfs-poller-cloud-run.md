...
fastapi==0.115.6                  # HTTP framework for POST /poll and GET /health endpoints
uvicorn[standard]==0.34.0         # ASGI server with httptools/uvloop for production HTTP serving
